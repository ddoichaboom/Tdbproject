...
CREATE TABLE `machine_slot` (
  ...
  CONSTRAINT `machine_slot_ibfk_2` FOREIGN KEY (`medi_id`) REFERENCES `medicine` (`medi_id`)
...
INSERT INTO `machine_slot` VALUES ('F7F8F9AA',1,'medicine_1762787136492',90,90),('F7F8F9AA',2,'supplement_1762787919297',60,60),('F7F8F9AA',3,'medicine_1762787587816',60,60);
...
-- Dump completed on 2025-11-12  0:54:57
